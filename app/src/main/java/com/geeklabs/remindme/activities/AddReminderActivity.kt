...
class AddReminderActivity : AppCompatActivity() {
    ...
    private lateinit var reminderPreferences: SharedPreferencesHandler // Changed to SharedPreferencesHandler
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        reminderPreferences = SharedPreferencesHandler(this) // Initialize SharedPreferencesHandler
